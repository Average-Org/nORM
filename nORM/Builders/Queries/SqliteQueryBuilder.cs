...
public class SqliteQueryBuilder : QueryBuilder
{
    ...
    public static readonly SqliteQueryBuilder Instance = new();
    ...
    public IExecutionProperties GetDeleteQuery<T>(T entity)
    {
        currentQuery = new();
    ...
    public IExecutionProperties GetInsertQuery<T>(T entity)
    {
        ...
        var properties = NormEntity.GetProperties(type);
        ...
        currentQuery.Remove(currentQuery.Length - 2, 2);
        currentQuery.Append("); SELECT last_insert_rowid();");
